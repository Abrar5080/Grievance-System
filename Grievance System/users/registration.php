...
if(isset($_POST['submit']))
{
	...
	$prn=$_POST['prn'];
	$status=1;
	$query=mysqli_query($bd, "insert into users(fullName,userEmail,password,PRN,status) values('$fullname','$email','$password','$prn','$status')");
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <input type="password" class="form-control" placeholder="Password" required="required" name="password"><br >
		             <input type="text" class="form-control" maxlength="20" name="prn" placeholder="PRN NO" required="required" autofocus>
		            <br>
