...
$query1 = mysqli_query($bd,"select priority from subcategory where subcategory = '".$subcat."'");
...
$query=mysqli_query($bd, "insert into tblcomplaints(userId,category,subcategory,complaintType,Department,noc,complaintDetails,complaintFile,adminId) values('$uid','$category','$subcat','$complaintype','$Department','$noc','$complaintdetials','$compfile','$adminId')");
...
<?php $sql=mysqli_query($bd, "select departmentName from department ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
