...
$sql=mysqli_query($bd, "insert into category(categoryName,categoryDescription,priority) values('$category','$description','$priority')");
...
<input type="text" placeholder="Enter category Name"  name="category" class="span8 tip" required>
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Select Priority</label>
											<div class="controls">
												<select name="priority" class="form-control no-border span5 tip " required>
