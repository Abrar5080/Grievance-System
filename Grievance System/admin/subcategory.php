...
$sql=mysqli_query($bd, "insert into subcategory(categoryid,subcategory,priority) values('$category','$subcat','$priority')");
...
<div class="control-group">
<label class="control-label" for="basicinput">SubCategory Priority</label>
